...
class TeamFound extends Model
{
    ...
    {
        return $this->hasone('store','store_id','store_id')->field('store_id,store_name,store_qq,store_phone,store_logo,store_avatar,qitian,store_free_price,certified,two_hour,returned');
    }
