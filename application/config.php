...
*/
    ...
    'mail'      => [
        ...
        // cookie 保存时间
        'port'    => 25,
        'username'    => "378557293@qq.com",
        'password'    => "kywdnpitkpqebghh",
        'receive'    => [ //收件人
            ["name" => "fdss","mail"=>'3343@qq.com'],
            ["name" => 'ruitukeji',"mail" =>'sds@ruitukeji.com' ]
        ],
    ],
    ...
    /**假设这个访问地址是 www.ruitukeji.cn/home/goods/goodsInfo/id/1.html 
    ...
    'HTML_CACHE_ARR'=> [
        ...
        ['mca'=>'home_Goods_ajaxComment','p'=>['goods_id','commentType','p']],  // 缓存评论静态页面 http://www.rtshop2.0.com/index.php?m=Home&c=Goods&a=ajaxComment&goods_id=142&commentType=1&p=1
        ['mca'=>'home_Goods_ajax_consult','p'=>['goods_id','consult_type','p']],  // 缓存咨询静态页面 http://www.rtshop2.0.com/index.php?m=Home&c=Goods&a=ajax_consult&goods_id=142&consult_type=0&p=2
     ...
     * cdn  图片上传
     */
    'ACCESSKEY' => '_lFb2XEtZUqNVlZfYkLeaSvacKdsbuAO7lQ3vp1m',//你的accessKey
    'SECRETKEY' => 'K_e8-69ZUTFPbZQuh4lDyZKBlNFtdBIhsIX-1qOP',//你的secretKey
    'BUCKET' => 'hdgx-img',//上传的空间
    'DOMAINImage'=>'http://p33opurtw.bkt.clouddn.com/',//空间绑定的域名
    ...
    //配置h5页面
    'huada_good_html'=>'http://shop.ruitukeji.cn:8504/html/product-img-detail.html?goods_id=',   //产品h5
    'huada_shop_html'=>'http://shop.ruitukeji.cn:8504/html/store-detail.html?shop_id=',//线下店铺
    'huada_shop_good_html'=>'http://shop.ruitukeji.cn:8504/html/offline-prod-info.html?shop_id=',//线下店铺产品   &shop_goods_id=
    'article_html'=>'http://shop.ruitukeji.cn:8504/html/article.html?id=',//文章h5
