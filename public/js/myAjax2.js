...
function changeTableVal(table,id_name,id_value,field,obj)
{
		...
		$.ajax({
				...
				success: function(data){
					if(data){
                        data = $.parseJSON(data);
                        $.each(data, function (index, cat_id) {
                            if(this_class=="no"){
                                $("#cat_"+cat_id).removeClass('no').addClass('yes');
                                $("#cat_"+cat_id).html("<i class='fa fa-check-circle'></i>是");
                            }else if(this_class=="yes"){
                                $("#cat_"+cat_id).removeClass('yes').addClass('no');
                                $("#cat_"+cat_id).html("<i class='fa fa-ban'></i>否");
                            }
                        });
					}else{
